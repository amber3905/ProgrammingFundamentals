...
public class Module {
	...
	public Module(Assessment assessment, Assessment assessment4, Assessment assessment5) {
	...
	public double calculateAverage() {
		double total = (assessment1.getMark() * 0.2) + (assessment2.getMark() * 0.2) + (assessment3.getMark() * 0.6);
		return total;
	}
